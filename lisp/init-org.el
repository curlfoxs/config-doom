...
;;       "a t" 'org-todo-list
;;       "a v" 'org-search-view
;;       "a f" 'org-roam-node-find
;;       "a i" 'org-roam-node-insert
;;       "a I" 'org-roam-node-insert-immediate
;;       "a c g" 'org-clock-goto
;;       "a c l" 'org-clock-in-last
;;       "a c i" 'org-clock-in
;;       "a c o" 'org-clock-out
;;       )
;;
...
(setq-default org-capture-templates my-org-capture-templates)
...
(when (and (eq system-type 'darwin) (file-directory-p "/Applications/org-clock-statusbar.app"))
